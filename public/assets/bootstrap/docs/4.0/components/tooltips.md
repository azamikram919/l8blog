...
- Tooltips rely on the 3rd party library [Popper.js](https://popper.js.org/) for positioning. You must include [popper..js]({{ site.cdn.popper }}) before bootstrap.js or use `bootstrap.bundle..js` / `bootstrap.bundle.js` which contains Popper.js in order for tooltips to work!
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <p>When a function is used to detere the placement, it is called with the tooltip DOM node as its first argument and the triggering element DOM node as its second. The <code>this</code> context is set to the tooltip instance.</p>
      </td>
    </tr>
    <tr>
      <td>selector</td>
